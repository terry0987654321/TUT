...
//			Debug.Log("XXXXXXXXXXXXXXXX to READ is " + toRead);
			while (toRead > 0) {
...
//			Debug.Log("YYYYYYYYYYYYYYY available is " + available);
		}
	...
	public class InflaterInputStream : Stream
	{
		...
		protected void Fill()
		{
			...
			if (inputBuffer.Available <= 0) {
				inputBuffer.Fill();
//				Debug.Log("ZZZZZZZZZZZZZZZ input available" +inputBuffer.Available );
				if (inputBuffer.Available <= 0) {
