...
//		}
		...
		/// <summary>
		/// Add the specified dataSource, entryName, compressionMethod and comment. [add by sj 2013-1-6]
		/// </summary>
		/// <param name="dataSource">The source of the data for this entry.</param>
		/// <param name="entryName">The name to give to the entry.</param>
		/// <param name="compressionMethod">The compression method to use.</param>
		/// <param name="comment">The comment of the entry , store some version and other stuff</param>
		public void Add(IStaticDataSource dataSource, string entryName, CompressionMethod compressionMethod, string comment)
		{
			if (dataSource == null) {
				throw new ArgumentNullException("dataSource");
			}
